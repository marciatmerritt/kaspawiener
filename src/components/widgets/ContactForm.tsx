    ...
    <div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
        ...
        <form action="#" method="POST" class="px-4 pb-8 pt-8 sm:pb-32 lg:px-8 lg:py-24">
            <div class="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
                ...
                <div class="mt-4 flex">
                <button type="submit" class="py-3 w-full px-5 text-sm font-medium text-center text-white rounded-sm bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Send message</button>
                </div>
            </div>
        </form>
    </div>
