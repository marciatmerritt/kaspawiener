...
export default component$(() => {
  return (
    ...
    <section class="relative rounded-lg  md:-mt-[76px] not-prose mx-1.5 my-1.5 bg-white/80 dark:bg-gray-900/80 border-radius-dot-25">
      <div class="relative max-w-7xl mx-auto px-4 sm:px-10 ">
        ...
        <div class="pt-6 md:py-20 lg:py-0 lg:flex lg:items-center lg:h-screen lg:gap-8">
          ...
          <span class="text-xs bg-primary rounded-full text-white px-4 py-1.5 mr-3">New</span> <span class="text-sm font-medium">25% Off Prints in January</span> 
